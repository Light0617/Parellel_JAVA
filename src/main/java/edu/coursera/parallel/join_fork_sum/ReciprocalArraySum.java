package edu.coursera.parallel.join_fork_sum;
...
public final class ReciprocalArraySum {
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        for(int i = 0; i < numTasks; i++){
            int left = getChunkStartInclusive(i, numTasks, input.length);
            int right = getChunkEndExclusive(i, numTasks, input.length);
            tasks[i] = new ReciprocalArraySumTask(left, right, input);
        }
